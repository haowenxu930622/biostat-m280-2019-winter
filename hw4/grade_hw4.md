...
-   Are there enough commits? Are commit messages clear? (-2 pts) 
    ...
    8 commits on `develop` branch. **Make sure** to start version control from the very beginning of a project. Make as many commits as possible during the process. 
