...
-   Q1 (24/25)
    - (-1 pt) \#6. Not included in Shiny app. 
...
-   Are there enough commits? Are commit messages clear? (-2 pts)
    ...
    3 commits in develop branch for homework 3. **Make sure** to start version control from the very beginning of a project. Make as many commits as possible during the process. 
